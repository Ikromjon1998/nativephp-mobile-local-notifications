 ...
 * @method static LocalNotificationsInterface transformUsing(callable(array<string, mixed>): array<string, mixed> $transformer)
 * @method static LocalNotificationsInterface flushTransformers()
 *
